...
/-! ### Finite maximal collection (Erdős's $10 question) -/
...
-/
theorem Theorem_Finite_Case : ∃ S, IsMaximalDisjointCollection S UnitSquare ∧ Set.Finite S := by
...
/-- **Erdős Problem 1071** ([Er87b, p.173], proved): both parts of Erdős–Tóth's
question have positive answers:
  (1) ($10 question, Danzer/Aristotle): there is a **finite** maximal disjoint
      collection of (open) unit segments in the closed unit square.
  (2) (Erdős/Alexeev): there is a **countably infinite** maximal disjoint
      collection of (open) unit segments in the closed unit square. -/
theorem erdos_1071 :
    (∃ S, IsMaximalDisjointCollection S UnitSquare ∧ Set.Finite S) ∧
    (∃ S, IsMaximalDisjointCollection S UnitSquare ∧
        Set.Countable S ∧ Set.Infinite S) :=
  ⟨Theorem_Finite_Case, Corollary_3⟩

#print axioms erdos_1071
-- 'Erdos1071.erdos_1071' depends on axioms: [propext, Classical.choice, Quot.sound]
