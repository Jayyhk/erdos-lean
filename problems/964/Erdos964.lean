...
The sequence of ratios `τ(n+1) / τ(n)` is dense in `(0, ∞)`. -/
theorem erdos_964 :
    Set.Ioi (0 : ℝ) ⊆ closure (Set.image (fun q : ℚ => (q : ℝ)) divisor_ratios) :=
  ErdosProblem964 goldston_graham_pintz_yildirim

#print axioms erdos_964
-- 'Erdos964.erdos_964' depends on axioms: [propext, Classical.choice, Erdos964.goldston_graham_pintz_yildirim, Quot.sound]
