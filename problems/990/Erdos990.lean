...
/-- **Erdős Problem 990** (disproved). There is no absolute constant `C` for the
sparse Erdős–Turán argument-discrepancy bound. -/
theorem erdos_990 :
...
-- 'Erdos990.erdos_990' depends on axioms: [propext, Classical.choice, Quot.sound]
